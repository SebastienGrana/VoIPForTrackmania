...
// Sécurité restante: raises the bar on the open TCP ingest port from "anyone
// on the internet" to "someone who has the community's token" — it does not
// identify individual players (no verifiable Trackmania identity exists to
// bind to). Left blank by default: a relay with no TCP_SHARED_SECRET
